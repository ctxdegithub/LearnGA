...
public:
     ...
     */
    static ThunderSlot* create(float fade, float minSeg, float stroke, const Color3B& color, const std::string& path);
     ...
     * @return An autoreleased MotionStreak object.
     */
    static ThunderSlot* create(float fade, float minSeg, float stroke, const Color3B& color, Texture2D* texture);
